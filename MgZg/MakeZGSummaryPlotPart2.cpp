...
int main()
{
   ...
   Latex.SetTextAlign(30);
   Latex.DrawLatex((BorderWidth + PanelWidth * 0.95) / TotalWidth, (BorderHeight + PanelHeight * 0.52) / TotalHeight, "140 < p_{T}^{jet} < 160 GeV");
   Latex.DrawLatex((BorderWidth + PanelWidth * 1.95) / TotalWidth, (BorderHeight + PanelHeight * 0.52) / TotalHeight, "250 < p_{T}^{jet} < 300 GeV");
   ...
   TLegend Legend((BorderWidth + PanelWidth * 0.35) / TotalWidth, (BorderHeight + PanelHeight * 0.80) / TotalHeight, (BorderWidth + PanelWidth * 0.80) / TotalWidth, (BorderHeight + 0.70 * PanelHeight) / TotalHeight);
